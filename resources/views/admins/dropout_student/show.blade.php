                            ...
                            <div class="box-body row">
                                <div class="col-6">
                                    <h4 class="form-section">
                                        ...
                                        قائمة غيابات الطالب - الانقطاع <span class="badge badge-danger">{{ $student_name }}</span>
                                    </h4>
                                </div>
                                <div class="col-6">
                                    <h4>
                                        <a href="{{ route('admins.dropout.students.index') }}" class="btn btn-primary">العودة لقائمة الطلاب المنقطعين</a>
                                    </h4>
                                </div>
                            </div>
