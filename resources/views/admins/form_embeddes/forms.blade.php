        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">النماذج المضمنة - Forms Embedded</h4>
                    <a href="{{ route('admins.forms-service.create') }}" class="btn btn-primary mt-2">إضافة طلب جديد</a>
                                    ...
                                    <tbody id="table_appliedRequests">
                                        @foreach($forms as $key => $form)
                                            <tr class="" style="background: lemonchiffon; color: #0a001f; font-weight: bold">
                                                ...
                                                <td>{{ $form->status }}</td>
                                                <td>
                                                    <a href="{{ route('admins.forms-service.edit', $form->id) }}" class="btn btn-warning">
                                                        تعديل
                                                        <i class="fa fa-edit"></i>
                                                    </a>
{{--                                                    <a href="{{ route('admins.forms-service.destroy', $form->id) }}" class="btn btn-danger">--}}
{{--                                                        حذف--}}
