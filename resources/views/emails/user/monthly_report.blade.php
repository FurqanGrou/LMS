            ...
            <table dir="rtl" style="width: 100%; font-weight: bold; border-collapse: collapse;">
                ...
                <tr style="height: 40px;">
                    ...
                    <td style="border: 1px solid gray;width: 30px; font-size: 16px; text-align: center;font-family: arial, sans-serif">
                        {{ $student->monthlyScores()->first()->new_lessons_not_listened ?? 0 }}
                    </td>
                </tr>
                <tr style="height: 40px">
                    ...
                    <td style="border: 1px solid gray;width: 30px;font-size: 16px;text-align: center;font-family: arial, sans-serif">
                        {{ $student->monthlyScores()->first()->last_five_pages_not_listened ?? 0 }}
                    </td>
                </tr>
                <tr style="height: 40px">
                    <td colspan="3" style="padding-right:10px;text-align: right;border: 1px solid gray;font-size: 16px;font-family: arial, sans-serif">
                    ...
                    <td style="border: 1px solid gray;width: 30px;font-size: 16px;text-align: center;font-family: arial, sans-serif">
                        {{ $student->monthlyScores()->first()->daily_revision_not_listened ?? 0 }}
                    </td>
                </tr>
                <tr style="height: 40px">
                    <td colspan="3" style="padding-right:10px;text-align: right;border: 1px solid gray;font-size: 16px;font-family: arial, sans-serif">
                    ...
                    <td style="border: 1px solid gray;width: 30px;font-size: 16px;text-align: center;font-family: arial, sans-serif">
                        {{ $student->monthlyScores()->first()->absence_excuse_days ?? 0 }}
                    </td>
                </tr>
                <tr style="height: 40px">
                    ...
                    <td style="border: 1px solid gray;width: 30px;font-size: 16px;text-align: center;font-family: arial, sans-serif">
                        {{ $student->monthlyScores()->first()->absence_unexcused_days ?? 0 }}
                    </td>
                </tr>
                <tr style="height: 40px">
                    <td colspan="3" style="padding-right:10px;text-align: right;border: 1px solid gray;font-size: 16px;font-family: arial, sans-serif">
                    ...
                    <td style="border: 1px solid gray;width: 30px; font-size: 16px; text-align: center;font-family: arial, sans-serif">
                        {{ $student->monthlyScores()->first()->lessonPage->page_number ?? '-' }}
                    </td>
                </tr>
                <tr style="height: 40px">
                    <td colspan="3" style="padding-right:10px;text-align: right;border: 1px solid gray;font-size: 16px;font-family: arial, sans-serif">
                    ...
                    <td style="border: 1px solid gray;width: 30px; font-size: 16px; text-align: center;font-family: arial, sans-serif">
                        {{ $student->monthlyScores()->first()->lessonPage->lesson_title ?? '-' }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="font-size: 16px;text-align: center;font-family: arial, sans-serif">
                        {{ getRate($student->monthlyScores()->first()->avg ?? 100, 'ar') }}
                        <br>
                        {{ getRate($student->monthlyScores()->first()->avg ?? 100, 'en') }}
                    </td>
                    <td style="font-size: 16px;text-align: center; background: #C6E0B4;font-family: arial, sans-serif">
                        نسبة
                        <br>
                    ...
                    <td style="font-size: 16px;text-align: center;font-family: arial, sans-serif">
                        {{ $student->monthlyScores()->first()->avg ?? 100 }}
                    </td>
                </tr>
                </tbody>
            </table>
