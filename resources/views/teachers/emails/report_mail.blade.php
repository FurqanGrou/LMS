<html><head></head><body>
<img style='display:block;margin-left:auto;margin-right:auto' src='https://reports.furqangroup.com/original/logo1.jpg' alt='Furqan Group' width='600' height='86' class='CToWUd'><div style='text-align: center;'>
        ...
        <div style=text-align='left';'>
            ...
            <span style='font-family: tahoma, arial, helvetica, sans-serif; font-size: 12pt;'>
              <span style='font-family: tahoma, arial, helvetica, sans-serif;'>Below is your child's performance report on
                <span style='color: #ff0000;'>{{ $details['grades']->date }}</span>, with details in the attached file about grades, student's performance and progress to view, monitor, and follow up at home
           ...
           <strong>
            <span style='font-family: tahoma, arial, helvetica, sans-serif;'>
                <span style='font-family: tahoma, arial, helvetica, sans-serif;'>نرجو الاطلاع على تقرير {{ $details['student_info']->section == 'male' ? 'ابنكم' : 'ابنتكم' }} ليوم
                 <span style='color: #ff0000;'>{{ substr($details['grades']->date, -10) }} </span>ومتابعة الابن{{ getTitleName($details['student_info']->section) }} في المنزل، كما يمكنكم الاطلاع على تفاصيل الدرجات ومستوى الطالب{{ getTitleName($details['student_info']->section) }} وتقدمه{{ $details['student_info']->section == 'female' ? 'ا' : '' }} من خلال الملف المرفق
               </span>
             </span>
            </strong>
          </span>
...
<table style='border-collapse: collapse; width: 100%;' border='1' style='height: 77px; width:100%' align='center'>
    ...
    <tr style='height: 51px;'>
        <td style='text-align: center; height: 51px; '>
            <h3>
                <span style='font-family: tahoma, arial, helvetica, sans-serif; font-size: 12pt; color: #000000;'>{{ $details['grades']->total }}</span>
            </h3>
        <td style='text-align: center; height: 51px; '>
            <h3>
                <span style='font-family: tahoma, arial, helvetica, sans-serif; font-size: 12pt; color: #000000;'>{{ $details['grades']->behavior_grade }}</span>
            </h3>
        </td>
        <td style='text-align: center; height: 51px; '>
            <h3>
                <span style='font-family: tahoma, arial, helvetica, sans-serif; font-size: 12pt; color: #000000;'>{{ $details['grades']->daily_revision_grade }}</span>
            </h3>
        </td>
        <td style='text-align: center; height: 51px; '>
            <h3>
                <span style='font-family: tahoma, arial, helvetica, sans-serif; font-size: 12pt; color: #000000;'>{{ $details['grades']->last_5_pages_grade }}</span>
            </h3>
        </td>
        <td style='text-align: center; height: 51px; '>
            <h3>
                <span style='font-family: tahoma, arial, helvetica, sans-serif; font-size: 12pt; color: #000000;'>{{ $details['grades']->lesson_grade }}</span>
            </h3>
        </td>
    </tr>
    </tbody>
